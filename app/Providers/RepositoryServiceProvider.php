...
use App\Repositories\Api\Employees\EmployeesRepository as EmployeeApiRepo;
use App\Repositories\Api\Employees\EmployeesRepositoryInterface as EmployeeApiRepoInteface;
...
class RepositoryServiceProvider extends ServiceProvider
{
    public function register()
    {
        ...
        $this->app->bind(EmployeeApiRepoInteface::class, EmployeeApiRepo::class);
    }
}
